...
class UsersControllerTest {
	...
	/**
	 * THESE TESTS WILL NEVER WORK WHEN SECURITY IS ENABLED
	 */
...
//				.perform(get("/api/findByUserName/test123").accept(MediaType.APPLICATION_JSON)).andReturn()
//				.getResponse();
//
...
//		MockHttpServletResponse response = mvc
//				.perform(post("/api/addUser").contentType(MediaType.APPLICATION_JSON).content(json)).andReturn()
//				.getResponse();
//
//		Assert.assertTrue(response.getStatus() == HttpStatus.OK.value());
//
