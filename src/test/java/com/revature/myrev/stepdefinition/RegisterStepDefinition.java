...
public class RegisterStepDefinition {
	...
	@When("User enters Username \"([^\"]*)\", First Name \"([^\"]*)\", Last Name\"([^\"]*)\", Email \"([^\"]*)\", Password \"([^\"]*)\"")
	public void user_enters_credentials_to_login(String username, String firstName, String lastName, String email, String password) {
