...
class UsersTest {
	...
	void usersToStringTest() {
		String test = "User [userId=" + "0" + ", age=" + "0" + ", userName=" + "null" + ", gender=" + "null" + ", photo="
				+ "null" + ", email=" + "null" + ", firstName=" + "null" + ", lastName=" + "null" + ", middleName="
				+ "null" + ", jobTitle=" + "null" + "]";
		Users testUser = new Users();
...
//		System.out.println("testUser.toString() = " + testUser);
	...
	void usersConstructorWithParamsTest() {
		...
		String test = "User [userId=" + userId + ", age=" + age + ", userName=" + userName + ", gender=" + gender + ", photo="
				+ photo + ", email=" + email + ", firstName=" + firstName + ", lastName=" + lastName + ", middleName="
				+ middleName + ", jobTitle=" + jobTitle + "]";
		Users testUser = new Users(userId, age, userName, password, gender, photo, email,
